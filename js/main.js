jQuery(document).ready(function ($) {
    ...
    $('.cd-trigger').on('click', function (event) {
        ...
        updateQuickView(slectedImageUrl, title, abstract);
    });
    ...
    function updateQuickView(url, title, abstract) {
        $('.cd-quick-view .cd-slider li img').attr('src', '');
        $('.cd-quick-view .cd-item-info h2').html('');
        ...
        $('.cd-quick-view .cd-item-info a').attr('href', thesisURL);
